        ...
        return (
            <div className="bg">
                ...
                <div className="twoButtons">
                    <button className='button purpleStyle' onClick={this.handleScoreAlertClick}>
                    ...
                    <button className='button purpleStyle' onClick={this.handleGuideAlertClick}>
                ...
                <div className='friends'>
                    <button className='friendsButton' onClick={this.handleShareAlertClick}>
                ...
                <div className={`purpleStyle alert ${this.state.showScoreAlert ? 'show' : ''}`}>
                ...
                <div className={`purpleStyle alert ${this.state.showGuideAlert ? 'show' : ''}`}>
                    <h2>راهنمای بازی</h2>
                    <p>
                        قواعد بازی: <br/>
                ...
                <div className={`purpleStyle alert ${this.state.showShareAlert ? 'show' : ''}`}>
